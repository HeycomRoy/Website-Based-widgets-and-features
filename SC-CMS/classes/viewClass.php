...
{	
	...
	private function displayHtmlHeader()
	{
		...
		if ($_GET['pageID'] == 'imageGallery') {
			$html .= '<link rel="stylesheet" href="css/imageRep.css" />'."\n";
			$html .= '<script type="text/javascript" src="lib/jquery/jquery.js">'."\n";
			$html .= '</script>'."\n";
			$html .= '<script type="text/javascript" src="lib/jquery/imageRep.js">'."\n";
			$html .= '</script>'."\n";
		}
	...
	{
		$pageArray = array('home','gallery', 'imageGallery','login','contact');
		$navArray  = array('Home', 'Products','Image Gallery','Login','Contact Us');
